    ...
    return (
        <div className="relative flex flex-col items-center justify-center w-full py-20">
            ...
            <div className="flex flex-col items-center justify-center gap-y-8 relative">
                <Container eager className="hidden lg:flex absolute inset-0 top-0 mb-auto flex-col items-center justify-center w-full min-h-screen -z-10">
                    <OrbitingCircles
                        speed={0.5}
                        radius={300}
                    >
                ...
                <div className="flex flex-col items-center justify-center text-center gap-y-4 bg-background/0">
                    <Container eager className="relative hidden lg:block overflow-hidden">
                        <button className="group relative grid overflow-hidden rounded-full px-2 py-1 shadow-[0_1000px_0_0_hsl(0_0%_15%)_inset] transition-colors duration-200 mx-auto">
                            ...
                            <span className="z-10 py-0.5 text-sm text-neutral-100 flex items-center">
                                ...
                                AI Mock Tests Now Available
                            </span>
                        </button>
                    </Container>
                    <Container eager delay={0.15}>
                    ...
                    <Container eager delay={0.2}>
                        <p className="max-w-xl mx-auto mt-2 text-base lg:text-lg text-center text-muted-foreground">
                            Upload your study materials, chat with AI, generate quizzes, and ace your exams with intelligent learning tools.
                        </p>
                    </Container>
